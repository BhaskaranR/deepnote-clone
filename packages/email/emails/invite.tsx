...
const baseUrl =
  process.env.VERCEL_ENV === "production"
    ? "https://business.deepnote-clone.com/email"
    : "http://localhost:3000/email";

const baseAppUrl =
  process.env.VERCEL_ENV === "production"
    ? "https://business.deepnote-clone.com"
    : "http://localhost:3000";

export const InviteEmail = ({
  invitedByEmail = "bukinoshita@example.com",
  invitedByName = "Bhaskaran Rathnachalam",
  email = "bhaskar@deepnote-clone.com",
  teamName = "Deepnote Clone",
        ...
        <Body className="bg-[#fff] my-auto mx-auto font-sans">
          ...
          >
            ...
            <Heading className="mx-0 my-[30px] p-0 text-[24px] font-normal text-[#121212] text-center">
              ...
              {t("invite.title2")} <strong>Deepnote Clone</strong>
            </Heading>
            ...
            <Text className="text-[14px] leading-[24px] text-[#121212]">
              ...
              {t("invite.link2")} <strong>Deepnote Clone</strong>.
            </Text>
