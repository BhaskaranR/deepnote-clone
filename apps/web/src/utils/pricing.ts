...
const BUSINESS_PLAN_MODIFIER = ({
  ...
  link: "https://deepnote-clone.com/help/article/business-plan",
  price: {
    monthly,
    yearly,
    ids,
  ...
  cta: {
    ...
    shortText: `Get ${name}`,
    href: "https://business.deepnote-clone.com/register",
  ...
  features: [
    ...
    },
    {
      ...
      footnote: {
        title:
          "Use Deepnote Clone Conversions to track how your link clicks are converting to signups and sales. Limits are based on the total sale amount tracked within a given month.",
        cta: "Learn more.",
        href: "https://business.deepnote-clone.com/help/article/business-plan",
      },
    },
    {
      id: "retention",
    ...
    },
    {
      ...
      footnote: {
        title:
          "Use webhooks to connect Deepnote Clone with your data stack and workflows – with native integrations for Segment, Zapier, Slack, and more.",
        cta: "Learn more.",
        href: "https://deepnote-clone.com/help/article/webhooks",
      },
    },
  ] as PlanFeature[],
});
...
export const PLANS = [
  {
    ...
    cta: {
      text: "Start for free",
      href: "https://business.deepnote-clone.com/signup",
      color:
