...
import { useLocalStorage, useMediaQuery } from "@deepnote-clone/ui/hooks";
import { CheckCircleFill, ThreeDots } from "@deepnote-clone/ui/icons";
import { CircleDotted, ExpandingArrow } from "@deepnote-clone/ui/icons";
import { OnboardingPopover } from "@deepnote-clone/ui/onboarding-popover";
...
function OnboardingButtonInner({
  ...
  const tasks = useMemo(() => {
    return [
      {
        display: "Create a new Deepnote Clone link",
        cta: `/${slug}`,
            ...
            <div className="flex items-start justify-between gap-2">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-300">
                  Get familiar with Deepnote Clone by completing the{" "}
