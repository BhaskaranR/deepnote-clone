...
import { createClient } from "@deepnote-clone/supabase/admin";
import { canJoinTeamByInviteCode } from "@deepnote-clone/supabase/mutations";
import { Avatar, AvatarFallback, AvatarImageNext } from "@deepnote-clone/ui/avatar";
import { Card, CardContent, CardFooter } from "@deepnote-clone/ui/card";
import type { Metadata } from "next";
import Link from "next/link";
import { Suspense } from "react";

export const metadata: Metadata = {
  title: "Join team | Deepnote Clone",
};
          ...
          <CardContent className="p-6 space-y-6">
            <div className="flex justify-center">
              <Avatar className="rounded-full w-8 h-8 cursor-pointer">
                {inviteData.team.avatar_url && (
                  <AvatarImageNext
                    src={inviteData.team.avatar_url}
                    alt={inviteData.team.team_name}
                    width={32}
                    height={32}
                    quality={100}
                  />
            ...
            <div className="space-y-4 text-center">
              ...
              <p className="text-gray-600">
                Empower your local business with Deepnote Clone! Easily list your
